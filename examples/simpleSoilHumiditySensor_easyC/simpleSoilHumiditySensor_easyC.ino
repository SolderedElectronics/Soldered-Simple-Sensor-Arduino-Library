 ...
 * @brief       Read all the values of the Simple Soiil Sensor with easyC.
 ...
 *
 *              Simple Soil Sensor easyC: solde.red/333043
...
void setup()
{
    ...
    // Set the threshold (percentage) which will turn on the LED and report that rain is detected
    rainSensor.setThreshold(62.4);
    ...
    // Note the reading of the Rain percentage, and then write that value in the calibrate function and uncomment it.
